...
function cardOvertime(d) {
  ...
  return card({ color: '#0f766e', icon, title: 'שעות נוספות', sub: 'הסכם ההתייעלות התפעולי', badge: 'תעריפים', badgeClass: 'ok',
    body: `${figure}
      ...
      הסכם ההתייעלות כולל גם תוכנית <b>פול גוררים</b> (פיילוט של 3 חודשים / 300 משמרות) ו<b>עדכון נורמות</b> למנופי גשר
      (ספרדר כפול) ב<b>פעימות שנתיות</b> — עד סך מצטבר של <b>12%</b> בכל מערכי הנורמות (הפירוט לכל פעימה כפוף לנוסח הנספח החתום).</div>` });
}
