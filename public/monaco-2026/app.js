  ...
  const I18N = {
    en: {
      ...
      about: [
        ...
        '<p>The fleet list combines the official MYS 2026 superyacht list with shipyard, broker and trade-press announcements as of 13 September 2026. Confidence is marked on each card: <b>Official list</b> or <b>Reported</b>. About 25 further yachts, mostly brokerage boats under 55 m, had not been named publicly at compile time; 28 published berth codes are used.</p>',
      ],
    },
    he: {
      ...
      about: [
        ...
        '<p>רשימת הצי משלבת את הרשימה הרשמית של MYS 2026 עם הודעות מספנות, ברוקרים ועיתונות מקצועית נכון ל-13 בספטמבר 2026. רמת הוודאות מסומנת בכל כרטיס: <b>ברשימה הרשמית</b> או <b>דווח</b>. כ-25 יאכטות נוספות, רובן סירות ברוקראז׳ מתחת ל-55 מ׳, טרם פורסמו בשמן; 28 קודי עגינה שפורסמו בשימוש.</p>',
      ],
    },
  };
  let lang = 'he';
