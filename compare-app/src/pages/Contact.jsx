      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr]">
        <div>
          ...
          <ul className="mt-6 space-y-3 text-sm">
            <li className="flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-xl bg-ice">📞</span><a className="font-bold text-navy hover:text-blue" href="tel:+972502423356" dir="ltr">050-242-3356</a></li>
            <li className="flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-xl bg-ice">✉️</span><a className="font-bold text-navy hover:text-blue" href="mailto:karin@karinkeren.com">karin@karinkeren.com</a></li>
            <li className="flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-xl bg-ice">💬</span><a className="font-bold text-navy hover:text-blue" href="https://wa.me/972502423356" target="_blank" rel="noopener">וואטסאפ – 050-242-3356</a></li>
